        ...
        <div class="col-md-7">
            <div class="card px-4" id="content">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('box/update/' . $box->box_code) ?>" method="POST" class="needs-validation" novalidate>

                        <div class="row justify-content-center mt-3">
                            <div class="col-md-12 mb-4">
                                <label for="nama-vendor" class="form-label">KODE BOX</label>
                                <input type="text" class="form-control" id="kode-box" value="<?=  $box->box_code?>" name="kode-box" disabled>
                            </div>
                            <div class="col-md-12 mb-4">
                                ...
                                <?php foreach ($shelfs as $s) { ?>
                                    <option <?php if($s->shelf_code == $box->shelf_code) echo 'selected="selected"' ?> value="<?= $s->shelf_code ?>"><?= $s->shelf_code . ' - RAK ' . $s->shelf_name ?></option>
                                    <?php 
                                } ?>
                                </select>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="number" class="form-control" id="kapasitas" value="<?= $box->capacity ?>" name="kapasitas" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea name="deskripsi-box" id="deskripsi-box" rows="3" class="form-control" required><?= $box->description ?></textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="d-flex justify-content-end mt-2 mb-3">
                            <input type="button" onclick="window.history.back()" value="Batal" class="btn btn-secondary btn-sm" style="margin-right: 8px;">

        ...
        <div class="col-md-8">
            ...
            <div class="card fw-semibold" id="content" style="font-size: 8pt; color: #000;">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('archive/document_new#content') ?>" class="btn btn-primary btn-sm mb-3 rounded-pill">Tambah Document</a>
                                        ...
                                        <!-- <div style="min-height: 120px;"> -->
                                            <div class="collapse collapse-horizontal" id="deletedocument<?= $document->document_id ?>">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <a style="color: red; margin-right: 8px;" href="<?= base_url('archive/document_delete/' . $document->document_id) ?>">Ya</a>

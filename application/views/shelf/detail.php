                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm rounded-pill mb-1 btn-modal" data-bs-toggle="modal" data-bs-target="#deleteBox<?= $box->box_id ?>">
                                        Hapus
                                    </button>
                            ...
                            <!-- DELETE vendor Modal -->
                            <div class="modal fade" id="deleteBox<?= $box->box_id ?>" aria-labelledby="deleteBoxLabel">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="d-flex justify-content-between">
                                                <h3>Ingin Menghapus Box <?= $box->box_code ?>?</h3>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="d-flex justify-content-end mt-5">
                                                <a href="#" data-bs-dismiss="modal" class="btn btn-secondary btn-sm" style="margin-right: 8px;">Tidak</a>
                                                <a href="<?= base_url('box/delete/' . $box->box_id) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
